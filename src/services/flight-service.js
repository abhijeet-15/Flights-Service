...
async function createFlight(data) {
    try {
        ...
        throw new AppError('Cannot create a new Flight object',
...
async function getFlight(id) {
    try {
        ...
        if(error.statusCode == StatusCodes.NOT_FOUND) {
            throw new AppError('The flight you requested does not exits', error?.statusCode);
        }
        throw new AppError('Cannot ftech data of the flight ',
            StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
